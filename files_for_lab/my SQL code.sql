...
--Query 7: What are the "5" account_ids with the lowest loan amount that have a loan duration of 60 in the loan table?
...
--Query 10: In the order t'able, which account_ids were responsible for orders between order_id 29540 and order_id 29560 (inclusive)?
