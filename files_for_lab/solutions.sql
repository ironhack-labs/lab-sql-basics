...
-- QUERY 17:
SELECT DISTINCT date, duration, COUNT(*) AS loan_count FROM loan WHERE date BETWEEN 971201 AND 971231 GROUP BY date, duration ORDER BY date ASC, duration ASC;

-- QUERY 18:
SELECT account_id, type, SUM(amount) AS sum_amount FROM trans WHERE account_id = 396 GROUP BY account_id, type ORDER BY type ASC;