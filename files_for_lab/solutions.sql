...
SELECT DISTINCT type, COUNT(*) FROM card GROUP BY type ORDER BY COUNT(*) DESC;
...
SELECT date, duration, COUNT(*) FROM loan WHERE date BETWEEN 971206	AND 971231 GROUP BY date, duration ORDER BY date ASC, duration ASC;
