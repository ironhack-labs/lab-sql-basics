...
-- Query 16
SELECT date, COUNT(*) AS loans_per_day
FROM loan
WHERE date &lt; 930907
GROUP BY date
ORDER BY date DESC;
...
ORDER BY type;</sql><current_tab id="0"/></tab_sql></sqlb_project>
