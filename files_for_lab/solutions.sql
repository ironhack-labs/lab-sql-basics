...
-- Can also get it with : SELECT max(client_id) FROM client WHERE district_id = 72;
...
-- Query 8 
SELECT DISTINCT k_symbol FROM 'order' WHERE k_symbol != " " ORDER BY k_symbol ASC;	-- A lot of values are " " , I decided to exclude them
