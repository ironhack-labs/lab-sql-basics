...
-- ***For query 7, I think it is asking for the account_id with the lowest loan amount so the code would be as shown below and the output should only be 10954
-- ***But to fulfill the output of what was written in the Read Me File, hence the code above**
SELECT account_id
FROM loan
WHERE duration = 60
  AND amount = (
