-- Query 1
SELECT id FROM client WHERE district_id = 1 ORDER BY id LIMIT 5;

-- Query 2
SELECT id FROM client WHERE district_id = 72 ORDER BY id DESC LIMIT 1;
...
-- Query 13
SELECT district_id, COUNT(id) FROM client WHERE district_id < 10 GROUP BY district_id ORDER BY district_id ASC;
...
-- Query 17
SELECT date, duration, COUNT(*) as count FROM loan WHERE date BETWEEN 971201 AND 971231 GROUP BY date, duration ORDER BY date ASC, duration ASC;
