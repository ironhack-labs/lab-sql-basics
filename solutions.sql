...
-- Query 8 
SELECT DISTINCT k_symbol FROM "order" WHERE k_symbol IS NOT NULL ORDER BY k_symbol ASC;
...
-- Query 17
SELECT date, duration, COUNT(*) AS num_loans FROM loan WHERE date BETWEEN 971201 AND 971231 GROUP BY date, duration ORDER BY date ASC, duration ASC;
