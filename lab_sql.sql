...
SELECT account_id ,SUM (amount) as total_amount FROM loan GROUP BY account_id ORDER BY total_amount DESC;

--Query 16
--In the loan table, retrieve the number of loans issued for each day, before (excl) 930907, ordered by date in descending order.
SELECT "date" ,COUNT (*) as loan_counts FROM loan WHERE "date" < 930907 GROUP BY "date" ORDER BY "date" DESC;
