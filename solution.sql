...
SELECT amount FROM loan WHERE amount ORDER BY amount ASC LIMIT 3; 
...
SELECT account_id, amount FROM loan WHERE account_id ORDER BY account_id ASC LIMIT 5;

--Query 7: What are the account_ids with the lowest loan amount that have a loan duration of 60 in the loan table?
SELECT account_id FROM loan WHERE duration == 60 AND amount ORDER BY amount ASC LIMIT 5;
